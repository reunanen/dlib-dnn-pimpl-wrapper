...
using net_type = dlib::loss_multiclass_log_per_pixel_weighted<
                            dlib::cont<default_class_count,5,5,2,2,
                            ...
                            level4<dlib::max_pool<3,3,2,2,
#endif // DLIB_DNN_PIMPL_WRAPPER_LEVEL_COUNT >= 1
                            dlib::relu<dlib::bn_con<dlib::con<8,5,5,2,2,
                            input_layer_type
                            >>>
#if DLIB_DNN_PIMPL_WRAPPER_LEVEL_COUNT >= 1
                            >>
...
using anet_type = dlib::loss_multiclass_log_per_pixel_weighted<
                            ...
                            alevel3<
#endif // DLIB_DNN_PIMPL_WRAPPER_LEVEL_COUNT >= 2
                            alevel4<dlib::max_pool<3,3,2,2,
#endif // DLIB_DNN_PIMPL_WRAPPER_LEVEL_COUNT >= 1
                            dlib::relu<dlib::affine<dlib::con<8,5,5,2,2,
                            input_layer_type
                            >>>
#if DLIB_DNN_PIMPL_WRAPPER_LEVEL_COUNT >= 1
                            >>
...
struct NetInputs {
    enum {
        count = Inputs<1,Inputs<DLIB_DNN_PIMPL_WRAPPER_LEVEL_COUNT,W,3,2>::count,5,2>::count
    };
};
template<int W>
struct NetOutputs {
    enum {
        count = Outputs<DLIB_DNN_PIMPL_WRAPPER_LEVEL_COUNT,Outputs<1,W,5,2>::count,3,2>::count
    };
};
