...
template <typename SUBNET> using level1 = res<8, /*res<8,*/ res_down<8, SUBNET>/*>*/>;
template <typename SUBNET> using level2 = res<8, /*res<8, res<8, res<8, res<8,*/ res_down<8, SUBNET>/*>>>>*/>;
template <typename SUBNET> using level3 = res<8, /*res<8, res<8,*/ res_down<8, SUBNET>/*>>*/>;
template <typename SUBNET> using level4 = res<8, /*res<8,*/ res_down<8, SUBNET>/*>*/>;

template <typename SUBNET> using alevel1 = ares<8, /*ares<8,*/ ares_down<8, SUBNET>/*>*/>;
template <typename SUBNET> using alevel2 = ares<8, /*ares<8, ares<8, ares<8, ares<8,*/ ares_down<8, SUBNET>/*>>>>*/>;
template <typename SUBNET> using alevel3 = ares<8, /*ares<8, ares<8,*/ ares_down<8, SUBNET>/*>>*/>;
template <typename SUBNET> using alevel4 = ares<8, /*ares<8,*/ ares_down<8, SUBNET>/*>*/>;

template <typename SUBNET> using level1t = res<8, /*res<8,*/ res_up<8, SUBNET>/*>*/>;
template <typename SUBNET> using level2t = res<8, /*res<8, res<8, res<8, res<8,*/ res_up<8, SUBNET>/*>>>>*/>;
template <typename SUBNET> using level3t = res<8, /*res<8, res<8,*/ res_up<8, SUBNET>/*>>*/>;
template <typename SUBNET> using level4t = res<8, /*res<8,*/ res_up<8, SUBNET>/*>*/>;

template <typename SUBNET> using alevel1t = ares<8, /*ares<8,*/ ares_up<8, SUBNET>/*>*/>;
template <typename SUBNET> using alevel2t = ares<8, /*ares<8, ares<8, ares<8, ares<8,*/ ares_up<8, SUBNET>/*>>>>*/>;
template <typename SUBNET> using alevel3t = ares<8, /*ares<8, ares<8,*/ ares_up<8, SUBNET>/*>>*/>;
